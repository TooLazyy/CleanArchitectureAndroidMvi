...
public class CircularRevealChangeHandlerCompatJ extends CircularRevealChangeHandlerJ {

    public CircularRevealChangeHandlerCompatJ() { }

    public CircularRevealChangeHandlerCompatJ(@NonNull View fromView, @NonNull View containerView) {
