...
public class CircularRevealChangeHandlerJ extends AnimatorChangeHandler {
    ...
    public CircularRevealChangeHandlerJ() { }
     ...
     */
    public CircularRevealChangeHandlerJ(@NonNull View fromView, @NonNull View containerView) {
     ...
     */
    public CircularRevealChangeHandlerJ(@NonNull View fromView, @NonNull View containerView, long duration) {
     ...
     */
    public CircularRevealChangeHandlerJ(@NonNull View fromView, @NonNull View containerView, boolean removesFromViewOnPush) {
     ...
     * @param removesFromViewOnPush If true, the view being replaced will be removed from the view hierarchy on pushes
     */
    public CircularRevealChangeHandlerJ(@NonNull View fromView, @NonNull View containerView, long duration, boolean removesFromViewOnPush) {
     ...
     */
    public CircularRevealChangeHandlerJ(int cx, int cy) {
     ...
     * @param duration The duration of the animation
     */
    public CircularRevealChangeHandlerJ(int cx, int cy, long duration) {
     ...
     * @param removesFromViewOnPush If true, the view being replaced will be removed from the view hierarchy on pushes
     */
    public CircularRevealChangeHandlerJ(int cx, int cy, boolean removesFromViewOnPush) {
     ...
     * @param removesFromViewOnPush If true, the view being replaced will be removed from the view hierarchy on pushes
     */
    public CircularRevealChangeHandlerJ(int cx, int cy, long duration, boolean removesFromViewOnPush) {
        super(duration, removesFromViewOnPush);
        this.cx = cx;
        this.cy = cy;
    }
